# Brewmanager, a Droplet for Droppy
...
- Droplet id: `brewmanager`. It is also `BrewmanagerDroplet.id` in Swift and `id` in `droplet.json`; the three must agree or the loader refuses the bundle.
- Swift product: `Brewmanager`, a dynamic library. The harness target is `BrewmanagerHarness`.
- SDK checkout: `/Users/dinanathdash/Documents/Projects/droppykit` (DroppyKit 1.8.1). Docs online: https://getdroppy.app/docs/droppykit
...
1. Edit `Sources/Brewmanager/`. The manifest is `droplet.json`.
2. `droppykit build` writes `.build/Brewmanager.droplet`, universal, linked against the
...
5. Put the bundle into Droppy Playground and confirm it loaded. Copy
   `.build/Brewmanager.droplet` to
   `~/Library/Application Support/Droppy Playground/Droplets/brewmanager/Brewmanager.droplet`,
...
and `.cursor/mcp.json` (Cursor). Codex: `codex mcp add droppykit -- /Users/dinanathdash/Documents/Projects/droppykit/Scripts/droppykit mcp`.
...
- **The principal class does nothing.** `BrewmanagerPrincipal` is `@objc`, is named in the
...
- **No `main.swift`.** The harness entry is `@main` in
  `Sources/BrewmanagerHarness/BrewmanagerHarness.swift`, and a file named `main.swift` cannot
  coexist with `@main`.
...
- **Do not edit anything under `/Users/dinanathdash/Documents/Projects/droppykit`.** That is the SDK checkout; fixes there go
...
- Guides, as Markdown: `/Users/dinanathdash/Documents/Projects/droppykit/Sources/DroppyKit/Documentation.docc/`
  ...
  workflow in full.
- The surface protocols, one file each: `/Users/dinanathdash/Documents/Projects/droppykit/Sources/DroppyKit/Capabilities/`
- The host services a droplet calls: `/Users/dinanathdash/Documents/Projects/droppykit/Sources/DroppyKit/Services/DropletServices.swift`
  and `/Users/dinanathdash/Documents/Projects/droppykit/Sources/DroppyKit/Core/DropletHost.swift`
- The manifest type, with every field documented: `/Users/dinanathdash/Documents/Projects/droppykit/Sources/DroppyKit/Bundle/DropletManifest.swift`
- Design tokens and the settings components: `/Users/dinanathdash/Documents/Projects/droppykit/Sources/DroppyKit/DesignSystem/`
- A complete droplet that uses every surface: `/Users/dinanathdash/Documents/Projects/droppykit/Examples/WorldClock/`
- The compatibility promise and the version ledger: `/Users/dinanathdash/Documents/Projects/droppykit/COMPATIBILITY.md`
...
```
Package.swift                     product Brewmanager (dynamic) and BrewmanagerHarness
droplet.json                      the manifest; Info.plist is generated from it
Sources/Brewmanager/              the droplet
Sources/BrewmanagerHarness/       the @main harness entry; never main.swift
Brewmanager.icon/                 Icon Composer document, required
Assets/Creator.png                square creator avatar, at least 256px, required
.build/Brewmanager.droplet        what droppykit build writes
